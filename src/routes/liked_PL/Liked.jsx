  ...
  return (
    <div className='w-full flex '>
      ...
      <div className=' w-full min-h-screen bg-[rgb(18,18,18)]'>
        <div className="likedFront w-full h-[450px] b">
          <div className="liked__wrapper flex items-end  gap-[30px]">
            <img className='liked__img' src={bigHeart} alt="" />
            <div className='liked-info '>
              <strong>Public Playlist</strong>
              <p className='likedTitle'>Liked Songs</p>
              <span className='flex gap-5 items-center'><img className='w-' src={chillmix} alt="" /><span>Username</span><span>• </span><span> 34 songs</span> </span>
              <br />
            </div>
          </div>
        </div>
